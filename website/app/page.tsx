...
const FEATURES = [
  {
    ...
    body: "Browse posts from everyone on the network or follow specific writers to curate your own feed. You decide what you see, not an algorithm. Follow anyone, unfollow instantly, and your feed updates in real-time.",
  },
  {
